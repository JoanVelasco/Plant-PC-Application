...
#if DEVICE == 1
#define CS_DEVICE_TYPE DEV_TYPE_COORDINATOR
#define CS_UID COORDINATOR_ADDRESS

#elif DEVICE == 2
#define CS_DEVICE_TYPE DEV_TYPE_ROUTER
#define CS_UID ROUTER_ADDRESS

#elif DEVICE == 3
#define CS_DEVICE_TYPE DEV_TYPE_ENDDEVICE
#define CS_UID ENDDEVICE_ADDRESS
#endif


#define STANDARD_SECURITY_MODE
